...
// CREATE HIRING OFFICE LAYER
var office = L.geoJSON(contracts, {
  style: function(feature) {
    var hiringName = feature.properties.hiringName;
    color = "black";
    if (hiringName == "Chattanooga") {
      color = "blue";
    } else if (hiringName == "Petersburg") {
      color = "orange";
    } else if (hiringName == "Wisewell Barracks") {
      color = "darkslategray";
    } else if (hiringName == "Camp Nelson") {
      color = "red";
    } else if (hiringName == "Louisville") {
      color = "magenta";
    } else if (hiringName == "Alexandria") {
      color = "aquamarine";
    } else if (hiringName == "Memphis") {
      color = "indigo";
    }
